      ...
      (entries) => {
        ...
        if (visibleSections.length > 0) {
          ...
          const closest = visibleSections.reduce((acc, curr) =>
            curr.boundingClientRect.top < acc.boundingClientRect.top
              ? curr
              : acc,
          );
          ...
          <div className="flex items-center gap-4 min-w-[200px]">
            ...
            <div className="flex items-center gap-3">
              <div
                ...
                style={{
                  backgroundColor: `color-mix(in srgb, ${data.accent} 10%, transparent)`,
                }}
              >
                <Image
                  src={data.logo}
      ...
      <div className="p-4 sm:p-5">
        ...
        {cmd.flags && cmd.flags.length > 0 && (
          <div className="mt-4 flex flex-wrap gap-2">
            {cmd.flags.map(
              (
                flag: string | { name: string; description?: string },
                i: number,
              ) => (
                <span
                  key={i}
        ...
        {cmd.example && (
          <div className="mt-4 border-t border-white/5 pt-4">
            <span className="text-xs text-neutral-500 uppercase tracking-wider font-semibold mb-2 block font-sans">
              Example
            </span>
